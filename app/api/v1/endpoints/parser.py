...
async def analyze_document_quality(document_id: str) -> DocumentAnalysisResponse:
    ...
    mock_analysis = DocumentAnalysisResponse(
        ...
        quality_level="良好",
        completeness=80.0,
        issues=[{"type": "warning", "message": "部分接口缺少示例", "location": "/api/users"}],
        suggestions=["建议为所有接口添加请求/响应示例", "建议完善错误响应的描述"],
        endpoints_count=1,
        analysis_details={
            "has_examples": False,
            "has_descriptions": True,
...
async def delete_document(document_id: str) -> Dict[str, Any]:
    ...
    return {"success": True, "message": "文档删除成功", "document_id": document_id}
