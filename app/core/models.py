...
class APIEndpoint(BaseModel):
    ...
    request_examples: List[Dict[str, Any]] = Field(default_factory=list, description="请求示例")
    
    # 响应信息
    responses: Dict[str, Dict[str, Any]] = Field(default_factory=dict, description="响应定义")
    response_examples: Dict[str, List[Dict[str, Any]]] = Field(default_factory=dict, description="响应示例")
...
class DocumentAnalysis(BaseModel):
    ...
    # 统计信息
    endpoints_by_method: Dict[str, int] = Field(default_factory=dict, description="按方法统计端点")
    endpoints_by_tag: Dict[str, int] = Field(default_factory=dict, description="按标签统计端点")
