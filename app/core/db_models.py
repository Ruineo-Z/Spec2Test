...
from app.core.models import DocumentQuality, HttpMethod, TestCaseType, TestStatus
...
class DocumentModel(Base):
    ...
    endpoints = relationship(
        "EndpointModel", back_populates="document", cascade="all, delete-orphan"
    )
...
class TestSuiteModel(Base):
    ...
    test_cases = relationship(
        "TestCaseModel", back_populates="test_suite", cascade="all, delete-orphan"
    )
...
class TestReportModel(Base):
    ...
    test_results = relationship(
        "TestResultModel", back_populates="test_report", cascade="all, delete-orphan"
    )
